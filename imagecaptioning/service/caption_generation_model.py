...
from imagecaptioning.utils.file_utils import save_tokenizer
from imagecaptioning.utils.logging_utils import log_metrics
from imagecaptioning.utils.metrics import tokenize_captions, calculate_corpus_bleu_score
        ...
        for batch in self.val_generator:
            ...
            for i in range(len(y_true)):
                ...
                bleu_score = sentence_bleu(
                    [true_tokens],
                    pred_tokens,
                    weights=(0.5, 0.5, 0, 0),  # Use only 1-gram and 2-gram with equal weights
