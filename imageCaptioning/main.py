...
# from domain.image_captioning_model import ImageCaptioningModel
...
# save_tokenizer(preprocessor.tokenizer, "tokenizer.pkl")
# feature_extractor.feature_extractor.save("feature_extractor.keras")
...
# )
# # caption_generator.generate_caption(os.path.join(BASE_DIR, 'Images', '667626_18933d713e.jpg'))
# caption_generator.generate_caption(os.path.join(BASE_DIR,'1.jpeg'))
# # Evaluate BLEU score on the validation set
# def evaluate_bleu_score(model, val_generator, tokenizer):
#     """
#     Evaluate the BLEU score on the validation set.
